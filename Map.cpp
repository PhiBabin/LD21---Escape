...
void MapTile::Draw(){
//    sf::Texture fun=m_map.GetTexture ().CopyToImage ();
//    int v=110,b=0;
//    cout<<"FUCKFUCKFUCKFUCK Color r="<<(int)fun.GetPixel(v,b).r<<"Color g="<<(int)fun.GetPixel(v,b).g<<"Color b="<<(int)fun.GetPixel(v,b).b<<endl;
